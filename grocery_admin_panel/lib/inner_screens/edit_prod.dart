    ...
    if (isValid) {
      ...
      try {
        ...
        if (_pickedImage != null) {
          print('Uploading updated image to Cloudinary...');
          imageUri = await CloudinaryService.uploadProductImage(
            fileName: widget.id,
            webImageBytes: kIsWeb ? webImage : null,
            file: kIsWeb ? null : _pickedImage,
          );
          print('✓ Image updated on Cloudinary');
        }
  ...
  DropdownButtonHideUnderline catDropDownWidget(Color color) {
    return DropdownButtonHideUnderline(
      child: DropdownButton<String>(
        ...
        items: const [
          DropdownMenuItem<String>(
            child: Text('Th.Phẩm Ăn Liền'),
            value: 'anlien',
          ),
          DropdownMenuItem<String>(
            child: Text('Th.Phẩm Chế Biến'),
            value: 'chebien',
          ),
          DropdownMenuItem<String>(
            child: Text('Th.Phẩm Đông Lạnh'),
            value: 'donglanh',
          ),
          DropdownMenuItem<String>(
            child: Text('Gia Vị'),
